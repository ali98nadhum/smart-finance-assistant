...
import { Plus, Users, CheckCircle, Clock, ChevronDown, ChevronUp, Wallet, ArrowRight, Landmark } from 'lucide-react';
...
const Debts = () => {
    ...
    const [newDebt, setNewDebt] = useState({ amount: '', personName: '', type: 'OWED_BY_ME' });
    ...
    const handleCreate = async (e) => {
        ...
        try {
            ...
            setIsAdding(false);
            setNewDebt({ amount: '', personName: '', type: 'OWED_BY_ME' });
            fetchDebts();
